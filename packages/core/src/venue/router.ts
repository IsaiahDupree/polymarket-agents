import { checkOrder as capsuleCheck } from "@risk/capsules/gate";
import { applyFillToCapsule } from "@risk/capsules/journal";
import { getCapsule, updateRealtime as updateCapsuleRealtime } from "@risk/capsules/store";
import { db } from "@/lib/db/client";
import { insertEvolutionEvent } from "@/lib/db/queries";
import { emptyPortfolio, getDefaultRiskEngine, type RiskEngine } from "@risk/engine";
import { getDefaultKillSwitch, type KillSwitch } from "@risk/kill-switch";
import type { PortfolioSnapshot } from "@risk/types";
